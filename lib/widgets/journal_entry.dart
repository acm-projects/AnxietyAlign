...
class _JournalEntryState extends State<JournalEntry> {
  ...
  Widget textEntry() =>
      Column(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
        ...
        TextFormField(
            ...
            style: const TextStyle(fontSize: 12.0, fontFamily: 'Wingdings'),
            maxLines: 9,
            minLines: 9)
      ]);
              ...
              ElevatedButton(
                  onPressed: () async {
                    ...
                    await recorder.startRecorder(
                        codec: Codec.pcm16, toStream: streamController.sink);
                  },
                  ...
                  child: Icon(Icons.play_arrow_rounded,
                      size: 40.0, color: widget.darkGreen)),
              Expanded(
                  child: SizedBox(
                      height: 35.0,
  ...
  Widget saveButton() => ElevatedButton(
      onPressed: () {
        ...
        StorageService(widget.userID)
            .setJournalDecibels(widget.timestamp.toString(), decibels);
        StorageService(widget.userID)
            .setJournalAudio(widget.timestamp.toString(), audio);
